...
def buscar_notificacoes(usuario_id):
    try:
        ...
        total_ancora_trafego = Amizade.query.filter_by(
            destinatario_id = usuario_id,
            tipo_notificacao = "ancora_ecommerce_trafego",
            visualizada=False

        ).count()

        total_deposito = Amizade.query.filter_by(
            destinatario_id = usuario_id,
        ...
        total_convite_turma = Amizade.query.filter_by(
            destinatario_id = usuario_id,
        ...
        total_quantidade_notificação = total_pendente + total_produto_cliente + total_produto_vendedor + total_ancora_trafego + total_deposito + total_convite_turma
        ...
        for notif in notificacoes:
            ...
            resultado.append({
                ...
                "valor_deposito":notif.valor_deposito,
                "id_turma_convite":notif.id_turma_convite,
                "nome_Turma":notif.nome_Turma
            })
            print(f"este é o tipo da notificação:{notif.tipo_notificacao}")
